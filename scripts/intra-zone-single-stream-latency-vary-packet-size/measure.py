...
Script to run the examples/intra-zone-single-stream-latency.cc simulation
...
BASE_OUTPUT_DIRECTORY = f"{ZONAL_DIRECTORY}/results/intra-zone-single-stream-latency/packet-size"
SINGLE_TEST_SCRIPT_PATH = f"{ZONAL_DIRECTORY}/examples/intra-zone-single-stream-latency.cc"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        prog='intra-zone-single-stream-latency-vary-packet-size',
        description='Measures latency of a single intra-zonal UDP stream with various' +
                    ' packet sizes.')
