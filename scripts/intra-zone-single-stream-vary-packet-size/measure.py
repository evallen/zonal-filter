...
Script to run the examples/intra-zone-single-stream.cc simulation
...
BASE_OUTPUT_DIRECTORY = f"{ZONAL_DIRECTORY}/results/intra-zone-single-stream/packet-size"
SINGLE_TEST_SCRIPT_PATH = f"{ZONAL_DIRECTORY}/examples/intra-zone-single-stream.cc"
